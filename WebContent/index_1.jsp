	...
	<div class="container-fluid">
		<div class="panel panel-success">
			<div class="panel-heading" align="center">
				<h2>
					<b><font color="black" style="font-family: fantasy;">Login to your account to access the site</font> </b>
				</h2>
			</div>
				...
				<div class="container " style="margin-top: 10%; margin-bottom: 10%;">
					...
					<div class="panel panel-success" style="max-width: 35%;" align="left">
						...
						<div class="panel-body">
							...
							<form action="ServletProject" method="post">
								<div class="form-group">
									<label for="exampleInputEmail1">Username</label> 
									<input type="text" class="form-control" name="txtUserName" 
									id="txtUserName" placeholder="Enter User Name" required="required">
			...
			<div class="panel-footer" align="center">
				<font style="color: #111">Copyright @2019 <a
